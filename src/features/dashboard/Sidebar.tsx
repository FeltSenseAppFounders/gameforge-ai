...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-gradient-to-b from-neutral-800 to-neutral-900 text-neutral-400 min-h-screen flex flex-col shrink-0">
      {/* Logo */}
      ...
      {/* Main nav */}
      <nav data-tour="sidebar" className="flex-1 px-3 flex flex-col gap-1">
        {navItems.map((item) => {
